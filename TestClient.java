/**
 * A test radius client. Again, all credit goes to Matthias Wuttke.
 * To be honest, I have yet to figure out how to fix the error in loading
 * the dictionary file. Anyone intend to do it, starts with DefaultDictionary
 * class.
 */
